...
const DesktopSidebar = ({ userName, onLogout }: DesktopSidebarProps) => {
  return (
    <div className="hidden md:flex md:w-64 md:flex-col fixed inset-y-0 z-10">
      <div className="flex flex-col flex-grow border-r border-gray-200 bg-white/80 backdrop-blur-md pt-5 pb-4 overflow-y-auto shadow-xl dark:bg-gray-900/80 dark:border-gray-700">
